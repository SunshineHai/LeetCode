...
![](https://s2.loli.net/2022/04/29/PQabB49I3pCYsDk.png)
要把以上excel表格中8点、14点、20点的数据，提取出来，然后转换成如下excel数据：

![](https://s2.loli.net/2022/04/29/Rq6r7p4JYL9wnWK.png)
...
![](https://s2.loli.net/2022/04/29/Mi9egnmDuSbGR1c.png)
...
# 得到下一个 sheet_namedef get_next_sheet(date_time: str):  
